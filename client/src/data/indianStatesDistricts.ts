...
export const INDIAN_STATES_AND_DISTRICTS: StateDistrictMap = {
  ...
  "Madhya Pradesh": [
    ...
    "Neemuch", "Pandhurna", "Panna", "Raisen", "Rajgarh", "Ratlam", "Rewa", 
    "Sagar", "Satna", "Sehore", "Seoni", "Shahdol", "Shajapur", "Sheopur", 
    "Shivpuri", "Sidhi", "Singrauli", "Tikamgarh", "Ujjain", "Umaria", "Vidisha"
  ],
  "Maharashtra": [
    "Ahilya Nagar (Ahmednagar)", "Akola", "Amravati", "Beed", "Bhandara", 
    "Buldhana", "Chandrapur", "Chhatrapati Sambhaji Nagar", "Dharashiv", 
  ...
  "Punjab": [
    ...
    "Rupnagar", "Sahibzada Ajit Singh Nagar", "Shaheed Bhagat Singh Nagar", 
    "Sri Muktsar Sahib", "Tarn Taran"
  ],
  "Rajasthan": [
    "Ajmer", "Alwar", "Anupgarh", "Banswara", "Baran", "Barmer", "Beawar", 
  ...
  "Lakshadweep": [
    "Kavaratti", "Agatti", "Amini", "Andrott", "Kadmat", "Kalpeni", "Minicoy"
  ],
  "Puducherry": [
...
export const INDIAN_STATES_LIST = Object.keys(INDIAN_STATES_AND_DISTRICTS).sort();
