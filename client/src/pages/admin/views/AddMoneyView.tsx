    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Add money to your Krivexa wallet using multiple payment options</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="xl:col-span-2 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between text-[11px] text-gray-500 px-2 gap-2">
            ...
            >
              Learn more about Krivexa Wallet <ArrowRight className="h-3 w-3" />
            </button>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm space-y-4">
            ...
            <div className="p-2.5 rounded-xl bg-emerald-50/80 border border-emerald-100 text-[10.5px] text-emerald-800 flex items-center gap-2">
              ...
              <span>Add money to your wallet and enjoy seamless transactions across Krivexa.</span>
            </div>
          </div>
