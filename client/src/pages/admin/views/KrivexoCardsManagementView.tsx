...
export default function KrivexoCardsManagementView() {
  ...
  const handleExport = () => {
    try {
      ...
      a.href = url;
      a.download = `Krivexo_Cards_${new Date().toISOString().slice(0, 10)}.csv`;
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-gray-900">Krivexo Kisan Card Management</h1>
      ...
      <div className="flex gap-4">
        ...
        {selectedCard && (
          <div className="w-72 space-y-4 shrink-0">
            {/* Realistic Krivexo Card Preview Box */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
              <p className="text-xs font-bold text-gray-800 mb-3">Krivexo Kisan Card Preview</p>
