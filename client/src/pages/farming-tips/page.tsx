...
const TIPS = [
  { category: "soil", title: "Test Your Soil Before Every Season", level: "Basic", desc: "Always get a soil test done before sowing. It tells you exactly which nutrients are lacking and how much fertilizer you need. This can save up to 20â30% on fertilizer costs.", steps: ["Collect soil from 8â10 spots in your field", "Mix them together and send 500g to a certified lab", "Apply fertilizers only as recommended in the report"] },
  { category: "water", title: "Use Drip Irrigation for Water Savings", level: "Intermediate", desc: "Drip irrigation delivers water directly to plant roots, reducing water use by 40â60% compared to flood irrigation while improving yield.", steps: ["Install drip lines along crop rows", "Set drip schedule based on crop need and weather", "Inspect lines weekly for clogging or leaks"] },
  { category: "pest", title: "Integrated Pest Management (IPM) Basics", level: "Intermediate", desc: "Combine biological, cultural, and chemical methods for sustainable pest control. IPM reduces pesticide costs by 25â40%.", steps: ["Monitor fields weekly for pest signs", "Use pheromone traps for early detection", "Apply pesticides only when pest count crosses threshold level"] },
  { category: "weather", title: "Pre-Monsoon Field Preparation", level: "Basic", desc: "Prepare your fields before the first rains to maximize water retention and reduce runoff and soil erosion.", steps: ["Deep plough fields in MayâJune before rains", "Create bunds to prevent water runoff", "Apply organic matter or FYM at 5 tonnes/acre"] },
  { category: "seeds", title: "Seed Treatment Before Sowing", level: "Basic", desc: "Treating seeds before sowing protects them from soil-borne diseases and improves germination by 15â20%.", steps: ["Soak seeds in Thiram or Carbendazim solution", "Dry treated seeds in shade for 30 minutes", "Sow within 24 hours of treatment for best results"] },
  { category: "soil", title: "Green Manuring to Improve Soil Fertility", level: "Intermediate", desc: "Growing crops like Dhaincha or Sunn Hemp and plowing them under adds nitrogen and organic matter, reducing chemical fertilizer needs.", steps: ["Sow Dhaincha at 20â25 kg/acre before kharif", "Allow to grow for 40â45 days", "Plow green crop into soil before flowering"] },
  { category: "water", title: "Rainwater Harvesting for Farm Ponds", level: "Advanced", desc: "Construct a farm pond to collect monsoon runoff. A 100Ã50 ft pond can store enough water for 1â2 irrigations in rabi season.", steps: ["Select lowest point in field for pond location", "Apply for government subsidy before construction", "Line pond with HDPE sheet to prevent water seepage"] },
  ...
  { category: "weather", title: "Cold Wave Protection for Rabi Crops", level: "Intermediate", desc: "Frost and cold waves can damage wheat, potato, and vegetable crops. Timely protection can prevent 20â30% yield loss.", steps: ["Light irrigation the evening before expected frost", "Apply mulch around plant base to retain heat", "Use polythene covers for vegetables in severe cold"] },
];
