...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      ...
      title3: "SMARTER",
      title4: "FUTURE.",
      desc: "Krivexo brings every farming solution to your fingertips — live mandi rates, buy inputs, sell crops, labour booking, and expert advice.",
    ...
    footer: {
      ...
      address: "Chakmehsi Kalyanpur, Samastipur, Bihar 848302",
  ...
  hi: {
    ...
    footer: {
      ...
      address: "चकमेहसी कल्याणपुर, समस्तीपुर, बिहार 848302",
  ...
  bn: {
    ...
    footer: {
      ...
      address: "চকমেহসি কল্যাণপুর, সমস্তিপুর, বিহার ৮৪৮৩০২",
